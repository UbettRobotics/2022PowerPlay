        ...
        */
        ...
        while (opModeIsActive()) {
            ...
            if (Math.abs(LStickX) > 0 || Math.abs(LStickY) > 0 || Math.abs(RStickX) > 0) {
                ...
                SetPower(v1 * 0.75, v2 * 0.75, v3 * 0.75, v4 * 0.75);
            ...
            if(dpadUp2 && linearSlide.getCurrentPosition() > slideHigh - 200) {
                linearSlide.setTargetPosition(linearSlide.getCurrentPosition() - 150);
                linearSlide.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                linearSlide.setPower(-slideFast);
            } else if(dpadDown2 && linearSlide.getCurrentPosition() < 15){
                linearSlide.setTargetPosition(linearSlide.getCurrentPosition() + 150);
                if(linearSlide.getCurrentPosition() + 150 >= 0) linearSlide.setTargetPosition(0);
                linearSlide.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                linearSlide.setPower(slideFast);
            } else if (RTrigger2 >= .1) {
                    linearSlide.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                ...
                if (linearSlide.getTargetPosition() >= 0 && linearSlide.getCurrentPosition() > -10) {
                        linearSlide.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
...
//            telemetry.addData("slide encoder", linearSlide.getCurrentPosition());
            ...
            telemetry.addData("GY2", imu.getAngularOrientation().firstAngle);
